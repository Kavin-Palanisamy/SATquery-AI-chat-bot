...
class GroundingResult(BaseModel):
    ...
    headline: Optional[str] = Field(None, description="Short user-friendly headline summary")
    details: Optional[str] = Field(None, description="Simple non-technical breakdown")
    location_description: Optional[str] = Field(None, description="Natural-language location description")
    confidence_qualitative: Optional[str] = Field("High", description="Qualitative confidence (High, Moderate, Low)")
    message: Optional[str] = Field(None, description="Detailed evidence description text")
